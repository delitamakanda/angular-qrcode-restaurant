    ...
    children: [
      {
        path: 'welcome',
        loadComponent: () =>
          import('./features/welcome/pages/welcome-page/welcome-page').then((m) => m.WelcomePage),
      },
      {
        path: 'menu',
        loadComponent: () =>
          import('./features/menu/pages/menu-page/menu-page').then((m) => m.MenuPage),
      },
      {
        path: 'cart',
        loadComponent: () =>
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/order-confirmation/pages/order-confirmation-page/order-confirmation-page').then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/order-tracking/pages/order-tracking-page/order-tracking-page').then(
